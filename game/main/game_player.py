...
class GamePlayer:
    ...
    def set_on_click_for_element (self, name: str, onclick) -> None:
        self.gui.get_element(name).set_on_click_listener(onclick)

    def set_on_click_args_for_element (self, name: str, args: dict) -> None:
    ...
    def update (self, mouse_position: Vector, mouse_down: bool, mouse_pressed: bool):
        ...
        self.game_state.update(mouse_position, mouse_down, mouse_pressed) # todo: ui shouldn't handle game interaction
